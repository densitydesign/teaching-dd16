...
Promise.all([d3.html("./question.html"), d3.html("./interactive/visualization-1.svg")])
  .then(function([html, svgDocument]) {
    ...
    d3.selectAll("#images > g > rect")
      .each(function() {
        ...
        let colorClass = color.toString()
                              ...
                              .replace("(","-")
                              .replace(")","");
        d3.select(this.parentNode).classed(colorClass, true);
    })
    ...
    d3.selectAll("#legend > g > g > rect").each(function() {
      ...
      let colorClass = color.toString()
                            ...
                            .replace("(","-")
                            .replace(")","");
      d3.select(this.parentNode.parentNode).classed(colorClass, true);
    })
